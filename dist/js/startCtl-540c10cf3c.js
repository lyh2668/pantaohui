...
.controller('StartCtl', function($scope, $state, $window, $location, WeixinService, WxConstant, webRequest, Locals) {
...
.controller('TabsCtrl', function($scope, $rootScope, $state) {
  $rootScope.$on('$ionicView.beforeEnter', function() {
		...
		if(statename === 'tabs.home' || statename === 'tabs.meet'||
			statename === 'tabs.news' || statename === 'tabs.mine' || statename === 'tabs.find') {
