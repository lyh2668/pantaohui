...
.service('myApplyMeetService', function($q, webRequest, SERVICE_API_URL, AuthService) {
var perPage = 15;
	...
	var refreshMeetList = function(params) {
		...
		webRequest.getServiceDataWithJsonp(SERVICE_API_URL.API_MINE_APPLY, meetParams).then( function(data) {
